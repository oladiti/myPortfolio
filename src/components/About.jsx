...
class About extends Component {
    render() {
        return (
            <>
                <div name='About' className=' py-8 max-xs:pt-20 lg:pt-32 md:pt-20   mb-64 xl:pt-48 xl:mb-72 max-xs:mb-48' >
                    <div className=' max-xs:-ml-0 xs:ml-10 sm:ml-8 md:pl-2  md:ml-16 lg:ml-16'>
                        <SectionHeading heading="About Me" />
                    </div>
                    <div className='section  max-xs:-my-10 md:-mt-24   flex-col justify-between   lg:flex-row '>
