...
const Contact = () => {
  ...
  return (
    <div name="Contact" className=' mb-16 h-full min-h-screen w-full flex  items-center md:pt-4 lg:pt-36   max-xs:-mt-36'>
      <div className='section max-xs:px-5 text-gray-900 max-xs:pt-40 xs:pt-36 xl:-mt-14'>
        ...
        <div className='flex justify-between max-md:flex-col gap-10  max-sm:px-4'>
          ...
          <form onSubmit={handleSubmit} className='flex gap-3 flex-col w-full md:w-1/2'>
            ...
            <button className=' mx-auto  hover:text-blue-800 flex  group text-black bg-aba rounded-md font-semibold px-10 py-3 xl:py-3  hover:scale-[1.02] duration-500'>Let's Connect
