...
const Contact = () => {
  ...
  return (
    <div name="Contact" className="mb-56 h-full min-h-screen w-full flex items-center md:pt-4 lg:pt-36 xl:pt-4">
      <div className="section max-xs:px-5 text-gray-900 max-xs:pt-28 xs:pt-36 xl:-mt-4">
        ...
        <div className="flex justify-between max-md:flex-col gap-10 max-sm:px-4">
          <img
            src={con}
            alt=""
            className="w-full max-w-lg md:max-w-md lg:max-w-md xl:max-w-lg h-auto md:h-80 max-xs:h-56 xs:h-64 sm:px-2 object-contain"
          />
