...
const Footer = () => {
  ...
  return (
    <div className="w-full text-gray-600 max-xs:px-3">
      <div className="section footer pb-5 max-xs:px-4">
        <div className="flex flex-wrap xs:pl-3 md:px-0 justify-between dark:text-gray-400 text-gray-600">
          ...
          <div className="w-full mt-8 xs:w-3/5 sm:w-full  lg:mt-0 lg:w-[30%] lg:pl-16">
            <h3 className="text-gray-600 text-xl font-bold pb-4 max-xs:text-center">Contact Information</h3>
            <div className="flex flex-col sm:flex-row lg:flex-col  gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
              <div className="text-[0.9rem]  font-advanced mt-2">
                ...
                <p className="flex items-center max-xs:justify-center dark:text-gray-400 gap-3">
                  <Map />
                  <span className="pt-4 dark:text-gray-400 max-xs:mx-3 xl:px-4">
                    127, Bamgbose Street, Lagos Island, Nigeria.
                  </span>
                </p>
              </div>
              <ul className="flex items-center gap-5 md:gap-3 justify-start">
      ...
      <div className="section py-5 font-advanced">
        <p className="text-md dark:text-gray-400 flex justify-center  items-center">
          <span className="px-2 pb-[0.2rem]"><CopyRight /></span> {`2023- ${year}`} | All Rights Reserved
        </p>
      </div>
    </div>
  );
