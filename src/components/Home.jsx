...
function Home() {
  return (
    <div name="Home" className="xl:-mt-20 md:mt-2 h-full min-h-screen w-full flex items-center xs:mb-24">
      <div className="section max-md:flex-col-reverse max-md:mt-28 max-md:pt-10 max-xs:mt-20 gap-10 md:gap-1 md:justify-between items-center md:flex-row-reverse w-full">
        <div className="flex flex-col gap-3 text-center text-gray-700 w-max md:w-4/5 lg:mt-40 md:mt-16 max-xs:px-4">
          ...
          <ul className="flex items-center z-40 gap-4 lg:gap-4 mx-auto w-44">
            {contactInfo.map(({ id, link, name, icon }) => (
              <li key={id} className="bg-black group relative w-10 h-8 flex justify-center items-center rounded-full mx-auto sm:grayscale cursor-pointer duration-[450ms] transition ease-in hover:grayscale-0 hover:scale-105 focus:grayscale-0 focus:scale-105 active:grayscale-0 active:scale-105">
