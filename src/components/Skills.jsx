...
const Skills = () => {
    return (
        <div name="Skills" className='  h-full max-xs:px-5 lg:pt-8 xl:-mt-[26rem] xl:pt-3   md:pt-2  min-h-screen w-full flex items-center lg:px-5 xl:px-10'>
            <div className="section  xs:px-6 sm:px-10 max-xs:mt-20  lg:px-5 lg:mt-8  xl:-mt-16 xs:mt-20">
